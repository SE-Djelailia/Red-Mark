...
-- Stamps observation_photos.project_id FROM THE OBSERVATION, so the composite
-- FKs below can force the observation and the photo to share a project.
CREATE OR REPLACE FUNCTION "public"."set_observation_photo_project"() RETURNS "trigger"
    LANGUAGE "plpgsql" SECURITY DEFINER
    SET "search_path" TO 'public'
    AS $$
BEGIN
  SELECT o.project_id INTO NEW.project_id
  FROM public.observations o
  WHERE o.id = NEW.observation_id;

  IF NEW.project_id IS NULL THEN
    RAISE EXCEPTION 'Cannot resolve the owning project for observation %', NEW.observation_id;
  END IF;
...
ALTER FUNCTION "public"."set_observation_photo_project"() OWNER TO "postgres";
REVOKE ALL ON FUNCTION "public"."set_observation_photo_project"() FROM PUBLIC;
...
CREATE OR REPLACE FUNCTION "public"."set_visit_phase_project"() RETURNS "trigger"
    ...
    AS $$
BEGIN
  SELECT v.project_id INTO NEW.project_id
  FROM public.site_visits v
  WHERE v.id = NEW.visit_id;

  IF NEW.project_id IS NULL THEN
    RAISE EXCEPTION 'Cannot resolve the owning project for visit %', NEW.visit_id;
  END IF;
...
-- created_by. companies is keyed on the firm directly rather than through a
-- project, so this is the only place the owning firm is derived.
CREATE OR REPLACE FUNCTION "public"."set_company_organization"() RETURNS "trigger"
    LANGUAGE "plpgsql" SECURITY DEFINER
    SET "search_path" TO 'public'
    AS $$
BEGIN
  ...
  END IF;
  IF NEW.organization_id IS NULL THEN
    RAISE EXCEPTION 'Cannot create a company: the current user belongs to no organization';
  END IF;
...
ALTER FUNCTION "public"."set_company_organization"() OWNER TO "postgres";
REVOKE ALL ON FUNCTION "public"."set_company_organization"() FROM PUBLIC;
...
ALTER FUNCTION "public"."comment_project_id"("p_photo_id" "uuid", "p_issue_id" "uuid", "p_visit_id" "uuid") OWNER TO "postgres";
...
ALTER FUNCTION "public"."shares_project_with"("p_user_id" "uuid") OWNER TO "postgres";
...
ALTER FUNCTION "public"."check_plan_project_consistency"() OWNER TO "postgres";
...
ALTER TABLE "public"."kv_store_9fe75696" OWNER TO "postgres";
...
COMMENT ON TABLE "public"."observation_photos" IS 'Cross-reference from a visit observation to the specific photos it cites. Many-to-many: an observation may cite several photos, a photo may be cited by several observations. Scoped to the project, not the visit, because the report screen deliberately allows borrowing photos from other visits.';

COMMENT ON COLUMN "public"."observation_photos"."project_id" IS 'The project both parents share, stamped by trigger from the observation. Exists to support the composite FKs that make a cross-project citation structurally impossible. Never set by the client.';

COMMENT ON COLUMN "public"."observation_photos"."sort_order" IS 'Editorial order in which the observation cites its photos. Not unique; ties broken by created_at.';
...
ALTER TABLE "public"."pin_placements" OWNER TO "postgres";
...
ALTER TABLE "public"."plan_files" OWNER TO "postgres";
...
COMMENT ON COLUMN "public"."projects"."contractor_company_id" IS 'Optional link to the firm-scoped companies directory. Coexists with the contractor_* text columns, which remain the source read by the report generators. No backfill performed in Stage 15.';
...
ALTER TABLE ONLY "public"."companies"
    ADD CONSTRAINT "companies_id_organization_id_key" UNIQUE ("id", "organization_id");
...
ALTER TABLE ONLY "public"."observations"
    ADD CONSTRAINT "observations_id_project_id_key" UNIQUE ("id", "project_id");
...
-- One company per name per firm, case- and whitespace-insensitive.
CREATE UNIQUE INDEX IF NOT EXISTS "companies_org_name_key" ON "public"."companies" USING "btree" ("organization_id", "lower"("btrim"("name")));

CREATE INDEX IF NOT EXISTS "idx_companies_org" ON "public"."companies" USING "btree" ("organization_id");
...
CREATE INDEX IF NOT EXISTS "idx_observation_photos_photo" ON "public"."observation_photos" USING "btree" ("photo_id");

CREATE INDEX IF NOT EXISTS "idx_observation_photos_project" ON "public"."observation_photos" USING "btree" ("project_id");

-- The read the report performs: one observation's photos, in citation order.
...
CREATE INDEX "kv_store_9fe75696_key_idx1" ON "public"."kv_store_9fe75696" USING "btree" ("key" "text_pattern_ops");



CREATE INDEX "kv_store_9fe75696_key_idx10" ON "public"."kv_store_9fe75696" USING "btree" ("key" "text_pattern_ops");



CREATE INDEX "kv_store_9fe75696_key_idx11" ON "public"."kv_store_9fe75696" USING "btree" ("key" "text_pattern_ops");



CREATE INDEX "kv_store_9fe75696_key_idx12" ON "public"."kv_store_9fe75696" USING "btree" ("key" "text_pattern_ops");



CREATE INDEX "kv_store_9fe75696_key_idx13" ON "public"."kv_store_9fe75696" USING "btree" ("key" "text_pattern_ops");



CREATE INDEX "kv_store_9fe75696_key_idx14" ON "public"."kv_store_9fe75696" USING "btree" ("key" "text_pattern_ops");



CREATE INDEX "kv_store_9fe75696_key_idx15" ON "public"."kv_store_9fe75696" USING "btree" ("key" "text_pattern_ops");



CREATE INDEX "kv_store_9fe75696_key_idx16" ON "public"."kv_store_9fe75696" USING "btree" ("key" "text_pattern_ops");



CREATE INDEX "kv_store_9fe75696_key_idx17" ON "public"."kv_store_9fe75696" USING "btree" ("key" "text_pattern_ops");



CREATE INDEX "kv_store_9fe75696_key_idx18" ON "public"."kv_store_9fe75696" USING "btree" ("key" "text_pattern_ops");



CREATE INDEX "kv_store_9fe75696_key_idx19" ON "public"."kv_store_9fe75696" USING "btree" ("key" "text_pattern_ops");



CREATE INDEX "kv_store_9fe75696_key_idx2" ON "public"."kv_store_9fe75696" USING "btree" ("key" "text_pattern_ops");



CREATE INDEX "kv_store_9fe75696_key_idx20" ON "public"."kv_store_9fe75696" USING "btree" ("key" "text_pattern_ops");



CREATE INDEX "kv_store_9fe75696_key_idx21" ON "public"."kv_store_9fe75696" USING "btree" ("key" "text_pattern_ops");



CREATE INDEX "kv_store_9fe75696_key_idx22" ON "public"."kv_store_9fe75696" USING "btree" ("key" "text_pattern_ops");



CREATE INDEX "kv_store_9fe75696_key_idx23" ON "public"."kv_store_9fe75696" USING "btree" ("key" "text_pattern_ops");



CREATE INDEX "kv_store_9fe75696_key_idx24" ON "public"."kv_store_9fe75696" USING "btree" ("key" "text_pattern_ops");



CREATE INDEX "kv_store_9fe75696_key_idx25" ON "public"."kv_store_9fe75696" USING "btree" ("key" "text_pattern_ops");



CREATE INDEX "kv_store_9fe75696_key_idx3" ON "public"."kv_store_9fe75696" USING "btree" ("key" "text_pattern_ops");



CREATE INDEX "kv_store_9fe75696_key_idx4" ON "public"."kv_store_9fe75696" USING "btree" ("key" "text_pattern_ops");



CREATE INDEX "kv_store_9fe75696_key_idx5" ON "public"."kv_store_9fe75696" USING "btree" ("key" "text_pattern_ops");



CREATE INDEX "kv_store_9fe75696_key_idx6" ON "public"."kv_store_9fe75696" USING "btree" ("key" "text_pattern_ops");



CREATE INDEX "kv_store_9fe75696_key_idx7" ON "public"."kv_store_9fe75696" USING "btree" ("key" "text_pattern_ops");



CREATE INDEX "kv_store_9fe75696_key_idx8" ON "public"."kv_store_9fe75696" USING "btree" ("key" "text_pattern_ops");



CREATE INDEX "kv_store_9fe75696_key_idx9" ON "public"."kv_store_9fe75696" USING "btree" ("key" "text_pattern_ops");
...
ALTER TABLE ONLY "public"."projects"
    ADD CONSTRAINT "projects_contractor_company_id_fkey" FOREIGN KEY ("contractor_company_id") REFERENCES "public"."companies"("id") ON DELETE SET NULL;
...
ALTER TABLE ONLY "public"."observation_photos"
    ADD CONSTRAINT "observation_photos_photo_id_fkey" FOREIGN KEY ("photo_id") REFERENCES "public"."photos"("id") ON DELETE CASCADE;

-- The cross-project guard: both ends must agree with the stamped project_id.
ALTER TABLE ONLY "public"."observation_photos"
    ADD CONSTRAINT "observation_photos_observation_project_fkey" FOREIGN KEY ("observation_id", "project_id") REFERENCES "public"."observations"("id", "project_id") ON UPDATE CASCADE ON DELETE CASCADE;
...
-- Read mirrors "Members can view observations". Writes mirror the OBSERVATIONS
-- policies (editor-only), not the photos ones: citing a photo edits the note.
-- Writes check BOTH ends, so an editor cannot cite a photo they cannot see.
CREATE POLICY "Members can view observation_photos" ON "public"."observation_photos" FOR SELECT USING ((EXISTS ( SELECT 1 FROM "public"."observations" "o" WHERE (("o"."id" = "observation_photos"."observation_id") AND "public"."is_project_member"("o"."project_id")))));

CREATE POLICY "Editors can create observation_photos" ON "public"."observation_photos" FOR INSERT WITH CHECK (((EXISTS ( SELECT 1 FROM "public"."observations" "o" WHERE (("o"."id" = "observation_photos"."observation_id") AND "public"."has_project_role"("o"."project_id", ARRAY['owner'::"text", 'editor'::"text"])))) AND (EXISTS ( SELECT 1 FROM "public"."photos" "p" WHERE (("p"."id" = "observation_photos"."photo_id") AND "public"."is_project_member"("p"."project_id"))))));

CREATE POLICY "Editors can update observation_photos" ON "public"."observation_photos" FOR UPDATE USING ((EXISTS ( SELECT 1 FROM "public"."observations" "o" WHERE (("o"."id" = "observation_photos"."observation_id") AND "public"."has_project_role"("o"."project_id", ARRAY['owner'::"text", 'editor'::"text"]))))) WITH CHECK (((EXISTS ( SELECT 1 FROM "public"."observations" "o" WHERE (("o"."id" = "observation_photos"."observation_id") AND "public"."has_project_role"("o"."project_id", ARRAY['owner'::"text", 'editor'::"text"])))) AND (EXISTS ( SELECT 1 FROM "public"."photos" "p" WHERE (("p"."id" = "observation_photos"."photo_id") AND "public"."is_project_member"("p"."project_id"))))));

CREATE POLICY "Editors can delete observation_photos" ON "public"."observation_photos" FOR DELETE USING ((EXISTS ( SELECT 1 FROM "public"."observations" "o" WHERE (("o"."id" = "observation_photos"."observation_id") AND "public"."has_project_role"("o"."project_id", ARRAY['owner'::"text", 'editor'::"text"])))));
...
-- than through is_project_member(): a contractor directory is firm-wide
-- reference data. Every writing command carries WITH CHECK, since an RLS
-- denial on UPDATE is a silent 0-row no-op and USING alone would permit
-- re-homing a row into another firm.
CREATE POLICY "Firm members can view companies" ON "public"."companies" FOR SELECT USING (("organization_id" = "public"."current_org_id"()));

CREATE POLICY "Firm members can create companies" ON "public"."companies" FOR INSERT WITH CHECK (("organization_id" = "public"."current_org_id"()));
...
GRANT ALL ON FUNCTION "public"."create_report"("p_project_id" "uuid", "p_visit_ids" "uuid"[], "p_location_ids" "uuid"[]) TO "anon";
GRANT ALL ON FUNCTION "public"."create_report"("p_project_id" "uuid", "p_visit_ids" "uuid"[], "p_location_ids" "uuid"[]) TO "authenticated";
GRANT ALL ON FUNCTION "public"."create_report"("p_project_id" "uuid", "p_visit_ids" "uuid"[], "p_location_ids" "uuid"[]) TO "service_role";
...
GRANT ALL ON FUNCTION "public"."set_observation_photo_project"() TO "anon";
...
GRANT ALL ON FUNCTION "public"."set_company_organization"() TO "service_role";
...
GRANT ALL ON FUNCTION "public"."comment_project_id"("p_photo_id" "uuid", "p_issue_id" "uuid", "p_visit_id" "uuid") TO "anon";
GRANT ALL ON FUNCTION "public"."comment_project_id"("p_photo_id" "uuid", "p_issue_id" "uuid", "p_visit_id" "uuid") TO "authenticated";
GRANT ALL ON FUNCTION "public"."comment_project_id"("p_photo_id" "uuid", "p_issue_id" "uuid", "p_visit_id" "uuid") TO "service_role";



GRANT ALL ON FUNCTION "public"."shares_project_with"("p_user_id" "uuid") TO "anon";
GRANT ALL ON FUNCTION "public"."shares_project_with"("p_user_id" "uuid") TO "authenticated";
GRANT ALL ON FUNCTION "public"."shares_project_with"("p_user_id" "uuid") TO "service_role";
...
GRANT ALL ON FUNCTION "public"."check_plan_project_consistency"() TO "anon";
GRANT ALL ON FUNCTION "public"."check_plan_project_consistency"() TO "authenticated";
GRANT ALL ON FUNCTION "public"."check_plan_project_consistency"() TO "service_role";

GRANT ALL ON FUNCTION "public"."set_construction_stage_organization"() TO "anon";
GRANT ALL ON FUNCTION "public"."set_construction_stage_organization"() TO "authenticated";
GRANT ALL ON FUNCTION "public"."set_construction_stage_organization"() TO "service_role";

GRANT ALL ON FUNCTION "public"."set_project_stage_source_org"() TO "anon";
GRANT ALL ON FUNCTION "public"."set_project_stage_source_org"() TO "authenticated";
GRANT ALL ON FUNCTION "public"."set_project_stage_source_org"() TO "service_role";
...
GRANT ALL ON TABLE "public"."kv_store_9fe75696" TO "anon";
GRANT ALL ON TABLE "public"."kv_store_9fe75696" TO "authenticated";
GRANT ALL ON TABLE "public"."kv_store_9fe75696" TO "service_role";
...
GRANT ALL ON TABLE "public"."pin_placements" TO "anon";
GRANT ALL ON TABLE "public"."pin_placements" TO "authenticated";
GRANT ALL ON TABLE "public"."pin_placements" TO "service_role";



GRANT ALL ON TABLE "public"."plan_files" TO "anon";
GRANT ALL ON TABLE "public"."plan_files" TO "authenticated";
GRANT ALL ON TABLE "public"."plan_files" TO "service_role";
...
GRANT ALL ON TABLE "public"."construction_stages" TO "anon";
GRANT ALL ON TABLE "public"."construction_stages" TO "authenticated";
GRANT ALL ON TABLE "public"."construction_stages" TO "service_role";
