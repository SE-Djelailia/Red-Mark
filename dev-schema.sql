...
GRANT SELECT,INSERT,UPDATE,DELETE ON TABLE "public"."observation_photos" TO "authenticated";

GRANT SELECT,INSERT,UPDATE,DELETE ON TABLE "public"."site_visit_stages" TO "authenticated";

GRANT SELECT,INSERT,UPDATE,DELETE ON TABLE "public"."lots" TO "authenticated";
