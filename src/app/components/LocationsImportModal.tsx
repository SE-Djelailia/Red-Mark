      ...
      <div className="min-h-screen px-4 flex items-center justify-center py-8 pb-20 safe-area-bottom">
        ...
        >
          ...
          <div className="p-5 border-b border-line flex items-center justify-between sticky top-0 bg-surface rounded-t-xl">
            ...
            <button
              onClick={onClose}
              className="w-9 h-9 flex items-center justify-center hover:bg-subtle rounded-lg transition-colors"
            >
              <X size={20} />
            </button>
          </div>
          ...
          <div className="p-5">
            {step === "select" && (
              <div className="space-y-4">
                ...
                <button
                  ...
                  className="w-full flex items-center justify-center gap-2 px-4 py-3 bg-subtle text-ink rounded-lg hover:bg-line transition-colors text-sm font-medium min-h-[44px]"
                >
                  <Download size={18} />
                ...
                {headerError && (
                  <div className="bg-brand-50 border border-brand-100 rounded-lg p-3 text-sm text-brand-strong flex items-start gap-2">
                ...
                <button
                  ...
                  disabled={isLoading}
                  className="w-full flex items-center justify-center gap-2 px-4 py-3 bg-brand-600 text-white rounded-lg hover:bg-brand-700 disabled:opacity-50 transition-colors text-sm font-medium min-h-[44px]"
                >
                  {isLoading ? (
                    <>
              ...
              <div className="space-y-4">
                ...
                <div className="flex gap-3 pt-2">
                  <button
                    ...
                    className="flex-1 py-3 bg-subtle text-ink rounded-lg hover:bg-line transition-colors font-medium disabled:opacity-50"
                  >
                    Annuler
                  </button>
                  <button
                    ...
                    disabled={isCommitting}
                    className="flex-1 py-3 bg-brand-600 text-white rounded-lg hover:bg-brand-700 transition-colors font-medium disabled:opacity-50 flex items-center justify-center gap-2"
                  >
            ...
            {step === "result" && result && (
              <div className="space-y-4">
                <div className="bg-resolved/10 border border-resolved/20 rounded-lg p-4 flex items-start gap-3">
                ...
                {result.errors.length > 0 && (
                  <div className="bg-brand-50 border border-brand-100 rounded-lg p-3 space-y-1 max-h-40 overflow-y-auto">
