...
export default function BackupManager() {
  ...
  const getDataStats = () => {
    ...
    return { users: users.length, projects: projects.length, visits: visits.length, photos: photos.length };
  };
        ...
        <div className="fixed bottom-20 left-4 bg-white rounded-lg shadow-2xl border border-gray-200 p-6 z-50 w-96 max-h-[80vh] overflow-y-auto">
          ...
          <div className="mt-4 p-3 bg-yellow-50 border border-yellow-200 rounded-lg">
            <p className="text-xs text-yellow-800">
              ⚠️ <strong>Auto-sauvegarde:</strong> Les données sont automatiquement 
              sauvegardées toutes les 30 secondes. Utilisez "Restaurer" si votre session 
              a été perdue.
            </p>
          </div>
