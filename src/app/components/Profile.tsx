...
export default function Profile() {
  ...
  return (
    <div className="min-h-screen pb-20 bg-canvas">
      {/* Contained settings column, deliberately NOT the Dashboard's
          max-w-6xl. This screen holds a name, four fields, two settings
          rows and a sign-out; stretched to full width it reads as a band
          of content floating above a void. A narrow centred column is the
          settings-page convention precisely because sparse content looks
          intentional contained and broken sprawled. Everything stacks in
          one vertical order, identical on phone and desktop — the only
      ...
      <div className="px-4 sm:px-6 py-5 max-w-2xl mx-auto space-y-6">
        ...
        >
          {/* One field per row at every width. A 2×2 grid inside a 672px
              column would leave each input barely 300px wide for no gain. */}
        ...
        <div className="text-center text-xs text-faint pt-2">RedMark v1.0.0</div>
      </div>
