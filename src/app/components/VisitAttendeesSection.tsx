    ...
    <div className="p-4 space-y-3 bg-canvas">
      ...
      <div className="flex gap-2 justify-end">
        <button
          ...
          disabled={saving}
          className="flex items-center gap-1 px-3 py-2 text-sm text-body hover:bg-subtle rounded-[4px] disabled:opacity-40 disabled:cursor-not-allowed min-h-[44px]"
        >
          <X size={16} />
          Annuler
        </button>
        <button
          ...
          className="flex items-center gap-1 px-4 py-2 text-sm bg-brand-600 text-white rounded-[4px] hover:bg-brand-700 active:bg-brand-800 disabled:opacity-40 disabled:cursor-not-allowed min-h-[44px]"
        >
          <Check size={16} />
