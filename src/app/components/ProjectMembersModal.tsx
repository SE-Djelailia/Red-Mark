      ...
      >
        ...
        <div className="sticky top-0 bg-white border-b border-gray-200 px-6 py-4 flex items-center justify-between">
          <div>
            ...
            <p className="text-sm text-gray-500 mt-1">{members.length} membre{members.length !== 1 ? "s" : ""}</p>
          </div>
          <button onClick={onClose} className="w-10 h-10 bg-gray-200 hover:bg-gray-300 rounded-full flex items-center justify-center text-gray-600 transition-colors">
            <X size={20} />
          </button>
        </div>
        ...
        <div className="p-6 space-y-6">
          ...
          {showInviteForm && (
            <div className="bg-gray-50 rounded-lg p-4 space-y-4">
              ...
              <div>
                <label className="block text-xs font-medium text-gray-700 mb-1">Adresse courriel *</label>
                <input
                  type="email"
                  value={inviteEmail}
              ...
              <div className="flex gap-2">
                ...
                >
                  {inviting ? <><Loader2 size={16} className="animate-spin" /> Envoi…</> : "Envoyer l'invitation"}
                </button>
              </div>
            </div>
          )}
          ...
          <div className="space-y-3">
            ...
            {loading ? (
              ...
              members.map(member => (
                <div key={member.id} className="bg-gray-50 rounded-lg p-4 flex items-start justify-between gap-3">
          ...
          <div className="bg-blue-50 rounded-lg p-4 border border-blue-200">
            ...
            <ul className="text-xs text-blue-800 space-y-1">
              <li><strong>Propriétaire :</strong> Contrôle total du projet et des membres</li>
              <li><strong>Collaborateur :</strong> Peut créer et modifier visites, photos et déficiences</li>
              <li><strong>Observateur :</strong> Peut uniquement consulter le projet</li>
            </ul>
          </div>
        </div>
      </div>
